...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/public/client.js");
/******/ })
/************************************************************************/
/******/ ({
...
fetch("http://localhost:3000/rovers/?rover=spirit").then(function (res) {
  return res.json();
}).then(function (data) {
  var photos = List(data.photos); // console.log(data.photos);

  var _data$photos$0$rover = data.photos[0].rover,
      landing_date = _data$photos$0$rover.landing_date,
      launch_date = _data$photos$0$rover.launch_date,
      name = _data$photos$0$rover.name,
      status = _data$photos$0$rover.status;
  var roverInfo = Map({
  ...
  var images = List(photos.map(function (photo) {
